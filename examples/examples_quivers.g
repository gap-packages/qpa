q1 := Quiver(["u","v"],[["u","u","a"],["u","v","b"], ["v","u","c"],["v","v","d"]]);
VerticesOfQuiver(q1);
ArrowsOfQuiver(q1);
...
IsQuiver("v1");
IsQuiver(q1);
IsAcyclicQuiver(q1); IsUAcyclicQuiver(q1); IsConnectedQuiver(q1); IsTreeQuiver(q1);
q2 := Quiver(["u","v"],[["u","v"],["v","u"]]);
IsAcyclicQuiver(q2); IsUAcyclicQuiver(q2); IsConnectedQuiver(q2); IsTreeQuiver(q2);
IsFinite(q1); IsFinite(q2);
q3 := Quiver(["u","v"],[["u","v"],["u","v"]]);
IsAcyclicQuiver(q3); IsUAcyclicQuiver(q3); IsConnectedQuiver(q3); IsTreeQuiver(q3); 
q4 := Quiver(2, []);
IsAcyclicQuiver(q4); IsUAcyclicQuiver(q4); IsConnectedQuiver(q4); IsTreeQuiver(q4);
######################
